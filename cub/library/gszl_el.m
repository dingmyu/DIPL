function [ zsl_accuracy, Y_hit5 ] = gszl_el( S_est, S_te_gt, testclasses_id, test_labels, param)
...
for i    = 1:size(dist,1)
    ...
    Y_hit5(i,:) = testclasses_id(I(1:param.HITK));    
end

n = 0;
for i  = 1:size(dist,1)
    if ismember(test_labels(i),Y_hit5(i,:))
        n = n + 1;
    end
end
