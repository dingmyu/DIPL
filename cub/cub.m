...
%         end
        %% main code
        param.HITK           = 1;  % 2:82  3:85 4:90.5 5:92 6:94 
        ...
        while(t<=max_iter)
            ...
            [zsl_accuracy_2]= zsl_el(X_te2, X_te_pro, param); 
            fprintf('the [%d] training [%d] CUB ZSL accuracy [S >>> V][%d]: %.1f%%\n',total,train_iter,t,zsl_accuracy_2*100);
            t = t+1;
        end
    filename=strcat('W_dmy',num2str(train_iter),'.mat');
    save(filename,'W');
